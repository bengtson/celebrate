defmodule Wiring do
  ...
  EEx.function_from_file(:def, :celebrate_entry, "lib/celebrate/web_ui/templates/celebrate_entry.html.eex",
  ...
  def get_upcoming_list do
    Celebrate.get_upcoming_celebrates(21)
...
#    [entry, age, days]
  ...
  def get_celebrate_age entry, year do
    ...
    days_in_year = case Date.leap_year?(today) do
      true -> 366
      false -> 365
    end
